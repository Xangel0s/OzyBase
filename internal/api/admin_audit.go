...
var adminAuditDescriptors = map[string]adminAuditDescriptor{
	...
	"POST /api/auth/users/:id/reset-password":                  {Action: "admin_user_password_reset", TargetParam: "id"},
	"DELETE /api/auth/users/:id":                               {Action: "admin_user_delete", TargetParam: "id"},
	"GET /api/auth/providers":                                  {Action: "auth_providers_read"},
	"GET /api/auth/config":                                     {Action: "auth_config_read"},
	"GET /api/auth/smtp":                                       {Action: "auth_smtp_read"},
	"PUT /api/auth/smtp":                                       {Action: "auth_smtp_update"},
	"POST /api/auth/smtp/test":                                 {Action: "auth_smtp_test"},
	...
	"GET /api/project/engram/autonomy":                         {Action: "engram_autonomy_read"},
	"POST /api/project/engram/autonomy":                        {Action: "engram_autonomy_update"},
	...
	"GET /api/project/security/requests":                       {Action: "security_access_requests_list"},
	"PATCH /api/project/security/requests/:id":                 {Action: "security_access_request_decide", TargetParam: "id"},
	...
	"GET /api/project/security/advisor/scan":                   {Action: "security_advisor_scan"},
	"POST /api/project/security/advisor/fix":                   {Action: "security_advisor_fix"},
	"POST /api/project/security/sessions/terminate-by-ip":      {Action: "security_sessions_terminate_by_ip"},
	"POST /api/project/security/sessions/terminate-by-country": {Action: "security_sessions_terminate_by_country"},
	...
	"GET /api/security/advisor/scan":                           {Action: "security_advisor_scan"},
	"POST /api/security/advisor/fix":                           {Action: "security_advisor_fix"},
	"POST /api/security/sessions/terminate-by-ip":              {Action: "security_sessions_terminate_by_ip"},
	"POST /api/security/sessions/terminate-by-country":         {Action: "security_sessions_terminate_by_country"},
...
func sanitizeAuditPayload(route string, body []byte) map[string]any {
	...
	if route == "/api/sql" {
		...
		confirmDanger, _ := parsed["confirm_danger"].(bool)
		return map[string]any{
