...
type Config struct {
	...
	RealtimeWALBridgeEnabled bool
	RealtimeWALSlot          string
	RealtimeWALPublication   string
	...
	StoragePolicyV2     bool
	RealtimeAuthzV2     bool
	FunctionsAsyncV1    bool
	LimitsEnforcementV2 bool
	RealtimeLegacyOpen  bool
}
...
func Load() (*Config, error) {
	...
	if anonKey == "" || isPlaceholderSecretValue(anonKey) {
	...
	if serviceRoleKey == "" || isPlaceholderSecretValue(serviceRoleKey) {
	...
	cfg := &Config{
		...
		StorageSignedKeyID:                getEnv("OZY_STORAGE_SIGNED_KEY_ID", "v1"),
		...
		RealtimeWALBridgeEnabled: strings.EqualFold(getEnv("OZY_REALTIME_WAL_BRIDGE", "false"), "true"),
		RealtimeWALSlot:          getEnv("OZY_REALTIME_WAL_SLOT", "ozybase_realtime_slot"),
		RealtimeWALPublication:   getEnv("OZY_REALTIME_WAL_PUBLICATION", "ozybase_realtime"),
		...
		// Feature Flags
		StoragePolicyV2:     strings.EqualFold(getEnv("OZY_STORAGE_POLICY_V2", "false"), "true"),
		RealtimeAuthzV2:     strings.EqualFold(getEnv("OZY_REALTIME_AUTHZ_V2", "false"), "true"),
		FunctionsAsyncV1:    strings.EqualFold(getEnv("OZY_FUNCTIONS_ASYNC_V1", "false"), "true"),
		LimitsEnforcementV2: strings.EqualFold(getEnv("OZY_LIMITS_ENFORCEMENT_V2", "false"), "true"),
		RealtimeLegacyOpen:  strings.EqualFold(getEnv("OZY_REALTIME_LEGACY_OPEN", "false"), "true"),
	}
