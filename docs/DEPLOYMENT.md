...
- self-hosted project model: [SELF_HOSTED_PROJECTS.md](./SELF_HOSTED_PROJECTS.md)
- usage and limits: [USAGE_LIMITS.md](./USAGE_LIMITS.md)
...
OzyBase is intentionally designed to fit Coolify well:
- shared PostgreSQL runtime
- logical projects instead of fake per-project DB creation
- one admin surface
- persistent volumes
- straightforward HTTPS + env management

For the full Coolify-oriented guide, see [COOLIFY_DEPLOYMENT.md](./COOLIFY_DEPLOYMENT.md).
