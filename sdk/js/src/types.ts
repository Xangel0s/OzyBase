 ...
 */
export type FlowKoreResponse<T> = {
    data: T;
    error: null;
} | {
    data: null;
 ...
 */
export type SingleResponse<T> = FlowKoreResponse<T>;

/**
 * Array response with optional count
 */
export type ListResponse<T> = FlowKoreResponse<T[]> & {
    count?: number;
};
...
export interface FlowKoreError {
    message: string;
    code?: string;
    status?: number;
    details?: unknown;
...
export interface FlowKoreClientOptions {
    /**
...
/**
 * Database schema type - will be generated by `flowkore gen-types`
