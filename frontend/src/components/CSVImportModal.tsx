            ...
            <div className="ozy-dialog-panel flex max-h-[92vh] w-full max-w-[1120px] flex-col">
                <div className="px-4 lg:px-6 py-4 border-b border-[#2e2e2e] flex items-center justify-between bg-[#1a1a1a]">
                    <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                            ...
                            <p className="text-[11px] text-zinc-500 truncate">{fileName || 'CSV file'}</p>
                        </div>
                    </div>
                    <button onClick={onClose} className="text-zinc-600 hover:text-zinc-200 transition-colors shrink-0">
                        <X size={18} />
                    </button>
                </div>
                ...
                <div className="flex-1 min-h-0 p-4 lg:p-6 flex flex-col gap-4 lg:gap-5 overflow-hidden">
                    ...
                    {(duplicates.length > 0 || empties.length > 0) && (
                        <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-3.5 flex gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-3 text-[10px] uppercase tracking-[0.16em] font-black text-zinc-500">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="w-16 bg-black border border-[#2e2e2e] text-[10px] text-zinc-300 rounded-lg px-2 py-1.5"
                                ...
                                {headers.map((header: any) => (
                                    <div key={header.index} className="flex flex-col md:flex-row md:items-center gap-2.5 bg-[#0f0f0f] border border-[#222222] rounded-xl p-2.5">
                                        <div className="flex-1 min-w-0">
                                            <div className="text-[11px] font-black uppercase tracking-widest text-zinc-300 truncate">{header.label}</div>
                ...
                <div className="px-4 lg:px-6 py-4 bg-[#111111] border-t border-[#2e2e2e] flex items-center justify-end gap-3">
                    <button
                        onClick={onClose}
