        ...
        <ModuleScrollContainer width="6xl" innerClassName="animate-in fade-in duration-500">
            <div className="flex items-center justify-between border-b border-border pb-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white uppercase tracking-tighter italic">Auth Providers</h1>
            ...
            {loading ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {providers.map((provider) => (
                        <div key={provider.name} className="bg-background border border-border rounded-md p-6 space-y-6 shadow-2xl">
                            <div className="flex items-start justify-between">
                                <div>
                                    <h2 className="text-xl font-bold text-white uppercase tracking-tight">{provider.name}</h2>
                                ...
                                <span className={`px-3 py-1 rounded-full text-[9px] font-medium border ${provider.enabled ? 'bg-green-500/10 border-green-500/20 text-green-500' : 'bg-zinc-900 border-zinc-800 text-zinc-500'}`}>
                            ...
                            <div className="space-y-4">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-medium text-zinc-500">Callback URL</p>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div>
                                        <p className="text-[10px] font-medium text-zinc-500">Login URL</p>
                            ...
                            <div className="flex flex-wrap gap-3 pt-2">
                                ...
                                <button
                                    ...
                                    className="px-4 py-2 bg-primary text-black rounded-md text-[10px] font-medium disabled:opacity-40 disabled:cursor-not-allowed"
                                >
                                    Test Login
                                </button>
                            </div>
