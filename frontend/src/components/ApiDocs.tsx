...
const ApiDocs = ({ page = 'intro', onViewSelect }: any) => {
    ...
    const getContent = () => {
        if (loading) return (
            <div className="flex flex-col items-center justify-center h-64 text-zinc-500 gap-4">
                ...
                <span className="text-[10px] font-medium">Compiling Documentation...</span>
            </div>
        );
            ...
            return (
                <div className="space-y-12">
                    <div className="p-8 bg-background border border-border rounded-md">
                        <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Database REST API</h2>
                        ...
                        <div className="relative max-w-md">
                            ...
                            <input
                                ...
                                className="w-full bg-[#111111] border border-border rounded-md pl-10 pr-4 py-2.5 text-xs text-white focus:outline-none focus:border-primary/50 transition-all font-medium"
                            />
                        </div>
                    </div>
                    ...
                    {schema?.tables?.filter((t: any) => t.name.toLowerCase().includes(tableSearch.toLowerCase())).map((table: any) => (
                        <div key={table.name} className="space-y-6">
                            <div className="flex items-center gap-3 border-b border-border pb-4">
                                ...
                                <h3 className="text-xl font-bold text-white uppercase tracking-tight">{table.name}</h3>
                            </div>

                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                <div className="space-y-6">
                                    <div>
                                        <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4">Columns & Types</h4>
                                        <div className="bg-background border border-border rounded-md overflow-hidden">
                                            {table.columns.map((col: any, i: any) => (
                                                <div key={i} className={`flex items-center justify-between px-4 py-3 text-xs border-b border-border last:border-0 hover:bg-zinc-900/50 transition-colors`}>
                                ...
                                <div className="space-y-6">
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4">Usage Example</h4>

                                    {/* GET Example */}
                                    <div className="bg-[#111111] border border-border rounded-md overflow-hidden">
                                        <div className="px-4 py-2 bg-[#131313] border-b border-border flex items-center justify-between">
                                            <span className="text-[9px] font-medium text-zinc-500">GET List</span>
                                    ...
                                    <div className="bg-[#111111] border border-border rounded-md overflow-hidden">
                                        <div className="px-4 py-2 bg-[#131313] border-b border-border flex items-center justify-between">
                                            <span className="text-[9px] font-medium text-zinc-500">Insert Row</span>
        ...
        switch (page) {
            case 'intro':
                return (
                    <div className="space-y-6">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Introduction</h2>
                            <p className="text-zinc-400 mb-6 leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div 
                                    onClick={() => onViewSelect?.('db_api')}
                                    className="p-6 bg-background rounded-md border border-border hover:border-primary/50 transition-all group cursor-pointer"
                                >
                                    <div className="w-10 h-10 bg-primary/10 border border-primary/20 rounded-md flex items-center justify-center mb-4 text-primary group-hover:scale-110 transition-transform">
                                        <Zap size={20} />
                                    </div>
                                    <h3 className="text-sm font-bold text-white mb-2 uppercase">REST API</h3>
                                ...
                                <div 
                                    onClick={() => onViewSelect?.('realtime_api')}
                                    className="p-6 bg-background rounded-md border border-border hover:border-primary/50 transition-all group cursor-pointer"
                                >
                                    <div className="w-10 h-10 bg-blue-500/10 border border-blue-500/20 rounded-md flex items-center justify-center mb-4 text-blue-500 group-hover:scale-110 transition-transform">
                                        <MousePointer2 size={20} />
                                    </div>
                                    <h3 className="text-sm font-bold text-white mb-2 uppercase">Realtime</h3>
            ...
            case 'auth_api':
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Authentication API</h2>
                            <p className="text-zinc-400 mb-6 leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                ...
                                <div className="p-6 bg-primary/5 border border-primary/20 rounded-md">
                                    <div className="flex items-center gap-2 mb-3">
                                        ...
                                        <h4 className="text-[10px] font-bold text-white uppercase tracking-widest">JWT Structure</h4>
                                    </div>
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Core Endpoints</h4>
                                    
                                    <div className="space-y-3">
                                        {/* Login */}
                                        <div className="p-4 bg-[#111111] rounded-md border border-border group hover:border-green-500/30 transition-all">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="flex items-center gap-3">
                                                    <span className="bg-green-500/20 text-green-500 text-[9px] font-bold px-2 py-0.5 rounded">POST</span>
                                        ...
                                        {/* Reset Password */}
                                        <div className="p-4 bg-[#111111] rounded-md border border-border group hover:border-blue-500/30 transition-all">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="flex items-center gap-3">
                                                    <span className="bg-blue-500/20 text-blue-500 text-[9px] font-bold px-2 py-0.5 rounded">POST</span>
                                        ...
                                        {/* OAuth */}
                                        <div className="p-4 bg-[#111111] rounded-md border border-border group hover:border-orange-500/30 transition-all">
                                            <div className="flex items-center justify-between mb-2">
                                                <div className="flex items-center gap-3">
                                                    <span className="bg-orange-500/20 text-orange-500 text-[9px] font-bold px-2 py-0.5 rounded">GET</span>
            ...
            case 'storage_api':
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Storage API</h2>
                            <p className="text-zinc-400 mb-6 leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                                <div className="p-6 bg-green-500/5 border border-green-500/20 rounded-md">
                                    <div className="flex items-center gap-2 mb-3">
                                        <Globe size={16} className="text-green-500" />
                                        <h4 className="text-[10px] font-bold text-white uppercase tracking-widest">Public Access</h4>
                                    </div>
                                ...
                                <div className="p-6 bg-red-500/5 border border-red-500/20 rounded-md">
                                    <div className="flex items-center gap-2 mb-3">
                                        <Shield size={16} className="text-red-500" />
                                        <h4 className="text-[10px] font-bold text-white uppercase tracking-widest">RLS Protected</h4>
                                    </div>
                            ...
                            <div className="space-y-8">
                                {/* Bucket Management */}
                                <div>
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4">Bucket Management</h4>
                                    <div className="space-y-3">
                                        <div className="p-4 bg-[#111111] rounded-md border border-border">
                                            <div className="flex items-center gap-3 mb-2">
                                                <span className="bg-blue-500/20 text-blue-500 text-[9px] font-bold px-2 py-0.5 rounded">GET</span>
                                        ...
                                        <div className="p-4 bg-[#111111] rounded-md border border-border">
                                            ...
                                            <div className="bg-black/40 p-3 rounded-md mt-3 font-mono text-[10px] text-zinc-500 italic">
                                ...
                                {/* File Operations */}
                                <div>
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4">File Operations</h4>
                                    <div className="bg-black/40 border border-border rounded-md overflow-hidden shadow-2xl">
                                        <div className="px-4 py-3 bg-[#131313] border-b border-border flex items-center justify-between">
                                            <span className="text-[9px] font-medium text-zinc-500">Upload File (cURL)</span>
            ...
            case 'realtime_api':
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Realtime API</h2>
                            <p className="text-zinc-400 mb-6 leading-relaxed">
                            ...
                            <div className="p-6 bg-[#111111] rounded-md border border-border mb-8">
                                <div className="flex items-center gap-3 mb-4">
                                    <span className="bg-blue-500/20 text-blue-500 text-[10px] font-bold px-2 py-0.5 rounded uppercase">Endpoint</span>
                                    <code className="font-mono text-sm tracking-tight"><span className="text-primary">GET</span> <span className="text-zinc-300">/api/realtime</span></code>
                                </div>
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Client Implementation (JS)</h4>
                                    <div className="bg-black/40 border border-border rounded-md overflow-hidden shadow-2xl">
                                        <div className="px-4 py-2 bg-[#131313] border-b border-border flex items-center justify-between">
                                            <span className="text-[9px] font-medium text-zinc-500">example.js</span>
                                        ...
                                        <div className="p-4 overflow-x-auto">
                                            <pre className="text-[11px] font-mono leading-relaxed">
                                                <code className="text-blue-400">const</code> <code className="text-white">source = </code> <code className="text-blue-400">new</code> <code className="text-primary">EventSource</code>( <code className="text-green-400">'/api/realtime'</code> );<br/>
                                                <br/>
                                                <code className="text-white">source.</code><code className="text-primary">onmessage</code> <code className="text-white">= (event) ={'>'} {'{'}</code><br/>
                                                <code className="text-zinc-500">  // Payload format: {"{ table: string, data: any }"}</code><br/>
                                                <code className="text-blue-400">  const</code> <code className="text-white">payload = JSON.</code><code className="text-primary">parse</code>(event.data);<br/>
                                                <code className="text-white">  console.</code><code className="text-primary">log</code>(<code className="text-green-400">'Table:'</code>, payload.table, payload.data);<br/>
            ...
            case 'edge_api':
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Edge Functions</h2>
                            <p className="text-zinc-400 mb-6 leading-relaxed">
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div className="p-6 bg-[#111111] rounded-md border border-border">
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest mb-4">Runtime Environment</h4>
                                ...
                                <div className="space-y-4">
                                    <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Example Script</h4>
                                    <div className="bg-black/40 border border-border rounded-md overflow-hidden shadow-2xl">
                                        <div className="px-4 py-3 bg-[#131313] border-b border-border flex items-center justify-between">
                                            <span className="text-[9px] font-medium text-zinc-500">validate_order.js</span>
                                        ...
                                        <div className="p-5 overflow-x-auto">
                                            <pre className="text-[11px] font-mono leading-relaxed">
                                                ...
                                                <code className="text-blue-400">const</code> <code className="text-white">items = ozy.</code><code className="text-primary">query</code>(<code className="text-green-400">"SELECT * FROM products WHERE id = $1"</code>, body.product_id);<br/>
                                                <br/>
                                                ...
                                                <code className="text-blue-400">  throw new</code> <code className="text-primary">Error</code>(<code className="text-green-400">"Out of stock"</code>);<br/>
                                                {'}'}
                                            </pre>
                                        </div>
                                    </div>
            ...
            case 'sdk':
                return (
                    <div className="space-y-8 animate-in fade-in duration-500">
                        <div className="p-8 bg-background border border-border rounded-md">
                            <h2 className="text-2xl font-bold text-white mb-4 uppercase tracking-tighter italic">Client Integration Patterns</h2>
                            ...
                            <div className="mb-6 p-5 rounded-md border border-amber-500/20 bg-amber-500/5">
                                <p className="text-[10px] font-medium text-amber-300 mb-2">Current Status</p>
                            ...
                            <div className="space-y-6">
                                <h4 className="text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Current OzyClient Pattern</h4>
                                <div className="bg-black/40 border border-border rounded-md overflow-hidden shadow-2xl">
                                    <div className="px-4 py-3 bg-[#131313] border-b border-border flex items-center justify-between">
                                    ...
                                    <div className="p-5 overflow-x-auto">
                                        <pre className="text-[11px] font-mono leading-relaxed">
                                            <code className="text-blue-400">class</code> <code className="text-primary">OzyClient</code> {'{'}<br/>
                                            ...
                                            <br/>
                                            <code className="text-blue-400">  async</code> <code className="text-primary">from</code>(table) {'{'}<br/>
                                            <code className="text-blue-400">    const</code> res = <code className="text-blue-400">await</code> <code className="text-primary">fetch</code>(`$<code className="text-white">{'{this.url}'}</code>/api/tables/$<code className="text-white">{'{table}'}</code>`, {'{'}<br/>
                                            ...
                                            <code className="text-white">    {'}'}</code>);<br/>
                                            <code className="text-blue-400">    return</code> res.<code className="text-primary">json</code>();<br/>
                                            <code className="text-white">  {'}'}</code><br/>
                                            <code className="text-white">{'}'}</code><br/>
                                            <br/>
                                            <code className="text-zinc-500">// Usage</code><br/>
                                            <code className="text-blue-400">const</code> <code className="text-white">ozy = </code> <code className="text-blue-400">new</code> <code className="text-primary">OzyClient</code>(<code className="text-green-400">'https://api.ozy.io'</code>, <code className="text-green-400">'YOUR_API_KEY'</code>);<br/>
                                            <code className="text-blue-400">const</code> <code className="text-white">{'{ data }'} = </code> <code className="text-blue-400">await</code> ozy.<code className="text-primary">from</code>(<code className="text-green-400">'users'</code>);
                                        </pre>
                                    </div>
                                </div>
                            </div>
            ...
            default:
                return (
                    <div className="flex flex-col items-center justify-center min-h-[50vh] text-zinc-500">
                        ...
                        <h2 className="text-xl font-medium opacity-50">Documentation</h2>
        ...
        <div className="flex flex-col h-full bg-background animate-in fade-in duration-500 overflow-hidden">
            ...
            <div className="px-8 py-10 border-b border-border bg-[#131313]">
                <div className="flex items-center gap-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold text-white uppercase tracking-tighter italic">API Documentation</h1>
            ...
            {/* Content */}
            <div className="p-8 flex-1 overflow-auto custom-scrollbar bg-[#111111]">
