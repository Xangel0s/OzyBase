...
import { PRIMARY_NAV, SUBMENUS, getDefaultViewForSection, getExplorerModule, getViewLabel, isPrimaryNavActive, shouldShowExplorer } from '../viewRegistry';

const Layout = ({ children, selectedView, selectedTable, workspaceId, onTableSelect, onMenuViewSelect, tables = [], refreshTables, onWorkspaceChange }) => {
            ...
            >
                ...
                <div className="flex-1 flex flex-col gap-1 w-full overflow-y-auto scrollbar-hide px-2">
                    {PRIMARY_NAV.map((item, i) => {
                        ...
                        const isActive = isPrimaryNavActive(item.id, selectedView);
                            ...
                            <button
                                ...
                                onClick={() => {
                                    if (item.id === 'tables' && tables.length > 0) {
                                        ...
                                        onMenuViewSelect(getDefaultViewForSection(item.id));
                                    }
                                }}
